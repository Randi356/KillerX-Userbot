...
async def amireallyalive(alive):
    ...
    await alive.edit("**Proses Boosting** **Killerx User**")
    await alive.edit("**Proses Boosting** **KillerX Userb**")
    await alive.edit("**Proses Boosting** **KillerX Userbo**")
    await alive.edit("**Proses Boosting** **KillerX Userbot**")
    await asyncio.sleep(1)
