...
from userbot import ALIVE_EMOJI, ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, VEGETA_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot
...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            ...
            f"**★ heads :** heads/Chilly-Userbot 0-x634i7u1 \n"
            f"**★ Revisi :** {revout}"
        )
    else:
        await event.edit(
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰╼━━━━━━━━━━━━━━━━━━━━━\n"
        f"• **Copyright :** [Chilly-Userbot Company LLC](https://github.com/Randi356/VEGETA-USERBOT) \n"
        f"• **License :** [Raphielscape Version 1.d](https://github.com/Randi356/VEGETA-USERBOT/blob/VEGETA-USERBOT/LICENSE) \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"│   **USERBOT TELEGRAM**  \n"
        f"╰╼════════════════════╾╯ \n"
        f"[License](https://github.com/Randi356/VEGETA-USERBOT/blob/VEGETA-USERBOT/LICENSE) | [Support Chat](t.me/Remix Suppot ) | "
...
async def redis(alive):
    ...
    await asyncio.sleep(3)
    output = (
        f"★ [Chilly-Userbot](https://github.com/Randi356/VEGETA-USERBOT) **Running Userbot Active!** ★\n\n"
        f"__**{VEGETA_TEKS_KUSTOM}**__\n\n"
        ...
        f"[Support Chat](https://t.me/RemixSupport) | [Support Channel](https://t.me/githubxsvshacker) | [License](https://github.com/Randi356/VEGETA-USERBOT/blob/VEGETA-USERBOT/LICENSE)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
