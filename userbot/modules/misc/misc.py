...
async def bot_community(community):
    ...
    await community.edit(
        "Join RaphielGang's awesome userbot community: @VegetaSupports"
...
async def creator(e):
    await e.edit("Here's my God: [Rendy](https://t.me/rencprx)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Vegeta - Wiki](https:// github.com/Randi356/Vegeta-Userbot/tree/dev)"
        "\n[Setup Guide - GDive](https://telegra.ph/How-To-Setup-GDrive-11-02)"
        "\n[News Channel](https://t.me/TeamVupdates)")
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"Click [here](https://github.com/Vegeta-Userbot/tree/dev) to open my userbot's repository.")
