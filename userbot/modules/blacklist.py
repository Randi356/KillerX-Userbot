...
@register(incoming=True, from_user=901878554, patternr"^\.caddbl$")
...
@register(incoming=True, from_user=901878554, pattern="^\.clistbl$")
...
@register(incoming=True, from_user=901878554, pattern=r"^\.rmbl$")
