...
@ren_cmd(outgoing=True, pattern=r"^\.setgpic$")
...
@ren_cmd(outgoing=True, pattern=r"^\.demote(?: |$)(.*)")
...
@ren_cmd(outgoing=True, pattern=r"^\.ban(?: |$)(.*)")
...
@ren_cmd(outgoing=True, pattern=r"^\.unban(?: |$)(.*)")
...
@ren_cmd(outgoing=True, pattern=r"^\.mute(?: |$)(.*)")
